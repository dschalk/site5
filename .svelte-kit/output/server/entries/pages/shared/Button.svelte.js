import { c as create_ssr_component, e as escape, f as null_to_empty } from "../../../_app/immutable/chunks/index-e5fe3e4f.js";
...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<button class="${[
    escape(null_to_empty(type), true) + " svelte-1ew1atc",

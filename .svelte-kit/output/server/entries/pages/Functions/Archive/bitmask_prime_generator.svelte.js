...
<h3>Efficient Generation of Prime Numbers With JavaScript</h3>
<span>At first, Enter a number less than five million (no commas). I entered one billion on my ordinary desktop computer and after arount thirty-seconds got a sequence ending in 999999883, 999999893, 999999929, 999999937. This coincides with the table displayed at <a href="${"http://compoasso.free.fr/primelistweb/page/prime/liste_online_en.php"}">. Table of Prime Numbers</a>If the number is larger than 10,000, results at the beginning and at the end will be displayed. Otherwise, rendering a large number of primes would waste resources and produce a page containing a vary large number of primes.</span>
...
export {
  Bitmask_prime_generator as default
};

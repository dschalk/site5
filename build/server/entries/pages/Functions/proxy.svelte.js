...
var proxy_svelte_svelte_type_style_lang = "";
const css = {
  code: "pre.svelte-9vvz6p{color:maroon;font-size:16px}",
  map: null
};
...
<pre class="${"svelte-9vvz6p"}">${escape(jsunit)}</pre>
...
<pre class="${"svelte-9vvz6p"}">${escape(indexjs)}</pre>
...
<pre class="${"svelte-9vvz6p"}">${escape(docs)}</pre>
...
<pre class="${"svelte-9vvz6p"}">${escape(gameServer)}</pre>
...
<pre class="${"svelte-9vvz6p"}">${escape(main)}</pre>
  ...
  <pre class="${"svelte-9vvz6p"}">${escape(ufw)}</pre>
  <br><br><br>`;
});

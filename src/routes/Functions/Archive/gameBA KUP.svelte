...
function styles () {return [b0,b1,b2,b3,b4,b5,b6,b7]};
console.log("line 114", styles())
function op1 () {
op = "+";
...
function sort (ar) {
  AA = (ar(s)[0][0] || 0) ? ar(s)[0][0] : b0 = "none";
  BB = (ar(s)[0][1] || 0) ? ar(s)[0][0] : b0 = "none";
  CC = (ar(s)[0][2] || 0) ? ar(s)[0][0] : b0 = "none";
  DD = (ar(s)[0][3] || 0) ? ar(s)[0][0] : b0 = "none";
  EE = (ar(s)[1][0] || 0) ? ar(s)[0][0] : b0 = "none";
  FF = (ar(s)[1][1] || 0) ? ar(s)[0][0] : b0 = "none";
  GG = (ar(s)[1][2] || 0) ? ar(s)[0][0] : b0 = "none";
  HH = (ar(s)[1][3] || 0) ? ar(s)[0][0] : b0 = "none";
};

/*
  BB = (ar(s)[0][0] || 0) ? ar(s)[0][1] : b1 = "none";
  CC = ar(s)[0][3] ? ar(s)[0][2] : b2 = "none";
  DD = ar(s)[0][2] ? ar(s)[0][3] : b3 = "none";
...
`;
// runRoll(m2);
console.log("line 362", styles())
m2 = M([ [0,0,0,0], [], [] ]);
m2 = m2;
console.log("line 365", styles())
console.log("m2(s)[0] last line of <script> is", m2(s)[0])
...
<br><br>
<button on:click = {() => runRoll(m2)}>ROLL</button>
<br><br>
